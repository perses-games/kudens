...
import games.perses.kudens.map.tiled.MapTileset
import games.perses.kudens.math.Matrix4
import games.perses.kudens.math.getFloat32Array
import games.perses.kudens.shader.ShaderProgram
import games.perses.kudens.shader.ShaderProgramMesh
import games.perses.kudens.shader.VertextAttributeInfo
...
object Textures {
  ...
  init {
    ...
    shaderProgram = ShaderProgram(
        Game.gl(),
        WebGLRenderingContext.Companion.TRIANGLES,
        vertexShaderSource,
  ...
  operator fun get(name: String) = textures[name] ?: throw IllegalArgumentException(
      "Texture with name $name is not loaded!"
  )
